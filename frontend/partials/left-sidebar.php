        ...
        <div class="art-info-bar">
          ...
          <div class="art-info-bar-frame">
            ...
            <div class="art-header">
              ...
              <!-- avatar end -->
              <!-- name -->
              <h5 class="art-name mb-10">Asaduzzaman</h5>
              <!-- post -->
              <div class="art-sm-text">Full Stack Developer</div>
            </div>
            <!-- info bar header end -->
            ...
            <div class="art-ls-social">
              <!-- social link -->
              <a href="https://facebook.com/asad.bdesh" target="_blank"><i class="fab fa-facebook"></i></a>
              <!-- social link -->
              <a href="https://github.com/asadbdp" target="_blank"><i class="fab fa-github"></i></a>
              <!-- social link -->
              <a href="https://www.linkedin.com/in/asaduzzaman-web-developer/" target="_blank"><i class="fab fa-linkedin-in"></i></a>
